...
preguntas_seleccionadas = {}  # Conjunto para mantener registro de preguntas seleccionadas
...
while correcto and n_pregunta < 3*p_level:
    ...
    if continuar == 'y':
        ...
        choose_level
        print("numero de preguntas: ", n_pregunta)
        ...
        if correcto and int(n_pregunta) < 3*int(p_level):
            ...
            os.system(op_sys)
        elif correcto and int(n_pregunta) == 3*int(p_level):
